...
export const Footer = () => {
 ...
 <section className="w-screen h-auto bg-black">
  <div id="footer-container" className="grid grid-cols-1 md:grid-cols-2">
    ...
    <div id="links" className="mx-6 md:ml-20 w-auto md:w-96 mt-6 grid grid-cols-3">
      ...
      {/* Payment logos span full 3 cols */}
      <div id="Pay-logos" className="col-span-3 flex flex-row gap-4 p-2 justify-center text-white">
    ...
    <div id="stay-connected" className="grid grid-cols-1 mt-6 mx-6 md:mr-20">
      ...
      <div id="consent" className="flex flex-row">
        ...
        <p className="text-sm text-white">
          I consent that Decal-Punk Inc may process my personal data for the purpose of direct marketing. 
          I can unsubscribe anytime via link in email and read details in Decal-Punk&apos;s Privacy Policy.
        </p>
      </div>
      <div id="buttons" className="flex flex-col sm:flex-row mt-6 gap-4">
        <div id="email_link" className="w-full sm:w-60 h-10 grid items-center justify-items-center rounded-lg bg-white">
          <Link href="/" className={`text-2xl text-black ${protestFont.className}`}>Email</Link>
        </div>
        <div id="subscribe_link" className="w-full sm:w-60 h-10 grid items-center justify-items-center rounded-lg bg-amber-300">
          <Link href="/" className={`text-2xl text-black ${protestFont.className}`}>Subscribe</Link>
        </div>
      </div>
      <ul className="flex flex-row gap-4 justify-center text-white mt-4">
  ...
  <div id="copyright" className="p-4 gap-2 items-center justify-center flex flex-row text-white">
    <FaRegCopyright />
    <p>Decal-Punk 2025</p>
  </div>
</section>
